...
## Table of Contents
  ...
  - [Quick Start](https://www.google.com/search?q=%23quick-start)
      ...
      - [Run the Scraper](https://www.google.com/search?q=%23run-the-scraper)
      - [Combine CSVs](https://www.google.com/search?q=%23combine-csvs)
      - [Process & Analyze](https://www.google.com/search?q=%23process--analyze)
  - [Usage Details](https://www.google.com/search?q=%23usage-details)
      - [Scraping Options](https://www.google.com/search?q=%23scraping-options)
      - [Combining Options](https://www.google.com/search?q=%23combining-options)
  - [Data Dictionary (Core Columns)](https://www.google.com/search?q=%23data-dictionary-core-columns)
...
**Tip:** Consider locking versions with a pinned `requirements.txt` file for reproducibility.
...
2.  In the column selection section, select all required columns (e.g., name, age, nationality, league, club, position, overall, potential, value, wage, contract\_until, foot, skill\_moves, weak\_foot, pace, dribbling, defending, etc.).
...
| `pace`, `dribbling`, ... | int | Key attribute groups (varies by edition)               |
